    ...
    try {
      ...
      const features: Feature[] = observations.map((obs) => ({
        ...
        properties: {
          ...
          sharpness_S: obs.attributes.sharpness_S,
          loudness_N: obs.attributes.loudness_N,
          roughtness: obs.attributes.roughtness ? obs.attributes.roughtness : null,
          fluctuation_strength_F: obs.attributes.fluctuation_strength_F,
          latitude: obs.attributes.latitude,
          longitude: obs.attributes.longitude,
          quiet: obs.attributes.quiet,
          cleanliness: obs.attributes.cleanliness,
          accessibility: obs.attributes.accessibility,
          safety: obs.attributes.safety,
          influence: obs.attributes.influence,
          landmark: obs.attributes.landmark,
          protection: obs.attributes.protection,
          wind_speed: obs.attributes.wind_speed,
          humidity: obs.attributes.humidity,
          temperature: obs.attributes.temperature,
          pressure: obs.attributes.pressure,
          pleasant: obs.attributes.pleasant,
          chaotic: obs.attributes.chaotic,
          vibrant: obs.attributes.vibrant,
          uneventful: obs.attributes.uneventful,
          calm: obs.attributes.calm,
          annoying: obs.attributes.annoying,
          eventful: obs.attributes.eventful,
          monotonous: obs.attributes.monotonous,
          overall: obs.attributes.overall,
          created_at: obs.attributes.created_at,
          updated_at: obs.attributes.updated_at,
          roughtness_R: obs.attributes.roughtness_R ? obs.attributes.roughtness_R : null,
